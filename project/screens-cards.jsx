...
function SwipeCardFront({ data = JAZZ, overlay = null }) {
  return (
    <div style={{
      ...
      borderRadius: 22,
      overflow: 'hidden',
      // Ruby outline ring + ruby-tinted drop shadow + deep base shadow
      // so the card reads as a discrete object against sapphire, not a
      // window into the same field.
      boxShadow:
        '0 0 0 1.5px var(--red),' +
        '0 0 0 4.5px rgba(200,36,58,0.18),' +
        '0 22px 50px rgba(0,0,0,0.55),' +
        '0 6px 16px rgba(200,36,58,0.22)',
    }}>
...
function SwipeCardBack({ data = JAZZ }) {
  return (
    <div style={{
      ...
      // Matches the front card's ruby ring so the deck reads as one
      // object across the flip.
      boxShadow:
        '0 0 0 1.5px var(--red),' +
        '0 0 0 4.5px rgba(200,36,58,0.18),' +
        '0 22px 50px rgba(0,0,0,0.55),' +
